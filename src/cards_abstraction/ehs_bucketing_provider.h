...
// Provides bucketing based on EHS and EHS Squared values.
class EhsBucketingProvider : public BucketingProvider
{
public:
	EhsBucketingProvider(const BucketConfig& config);
